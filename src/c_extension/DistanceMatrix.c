...
#endif
    void squared_distance_matrix(const double* X, const double* Y,
                                 const double* g, int m, int n, int d,
                                 double* dist) {
  int i, c, r, p, k;
  double *temp, *dist_ij;
...
__declspec(dllexport)
#endif
    void distance_matrix(const double* X, const double* Y, const double* g,
                         int m, int n, int d, double* dist) {
  int i;
